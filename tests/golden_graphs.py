...
source of truth for `tests/fixtures/graph_hashes_golden.json`; regenerate the
fixture with `python -m tests.regen_golden_hashes` after an intentional
identity change (a coordinated break), never to paper over a mismatch.
"""
